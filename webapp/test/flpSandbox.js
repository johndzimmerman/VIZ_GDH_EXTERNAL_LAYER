		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Vizualize External Layer",
									"targetURL": "#comkostalvizgdhexternallayer-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comkostalvizgdhexternallayer-display": {
								"semanticObject": "comkostalvizgdhexternallayer",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.kostal.vizgdhexternallayer",
									"url": sap.ui.require.toUrl("com/kostal/vizgdhexternallayer")
								}
							}
						}
					}
